...
use Freshworkx\OAuth2\Client\Provider\Thingiverse;
use League\OAuth2\Client\Tool\QueryBuilderTrait;
use PHPUnit\Framework\TestCase;
use Mockery as m;

class ThingiverseTest extends TestCase
{
    ...
    public function testUserData()
    {
        ...
        $userResponse->shouldReceive('getBody')->andReturn('{"id": ' . $userId . ', "name": "' . $name . '", "email": "' . $email . '"}');
    ...
    {
        $this->expectException(ThingiverseIdentityProviderException::class);
        $status       = rand(400, 600);
        $postResponse = m::mock('Psr\Http\Message\ResponseInterface');
